...
test( 'main.js imports + calls it with rollingFps', /import \{[^}]*updateWaterQuality[^}]*\} from '\.\/Track\.js\?v=1000213'/.test( main ) && /updateWaterQuality\( rollingFps \);/.test( main ) );
...
test( 'cache bumps present', /Track\.js\?v=1000213/.test( main ) && /v=1000213/.test( readFileSync( './index.html', 'utf8' ) ) );
