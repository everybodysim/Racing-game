...
async function init() {
	...
	function applyShinyFinish( material, mappedColor = null ) {
		...
		if ( mappedColor ) material.color.multiplyScalar( SHINY_MATERIAL_TUNING.brightnessBoost );
		if ( material.emissive && mappedColor ) {

			material.emissive.setRGB( mappedColor.r / 255, mappedColor.g / 255, mappedColor.b / 255 );
