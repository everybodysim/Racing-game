...
const MAGNET_MAX_DISTANCE_BLOCKS = 1.5;
const MAGNET_FORCE_PER_SECOND = 15.0;
...
async function init() {
	...
	function applyMagnetForceFor( targetVehicle, dt ) {
		...
		for ( const magnet of magnetEntries ) {
			...
			const falloff = 1 - ( distance / magnetMaxDistance );
			const impulse = MAGNET_FORCE_PER_SECOND * falloff * dt;
