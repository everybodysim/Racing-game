...
async function init() {
	...
	const leaderboardTrackIdLabel = document.getElementById( 'leaderboard-track-id' );
	...
	async function fetchTrackLeaderboard() {
		...
		if ( leaderboardTrackIdLabel ) leaderboardTrackIdLabel.textContent = `Track ID: ${ leaderboardTrackId }`;
