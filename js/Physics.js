...
export function buildWallColliders( world, debugGroup, customCells, extras = null ) {
	...
	const ELEVATED_SURFACE_HALF_H = 0.145 * S;
	const ELEVATED_SURFACE_HALF_XZ = CELL_HALF * S * 1.16;
	const ELEVATED_SURFACE_DROP = 0.4;
	const SLOPE_SURFACE_HALF_XZ = ELEVATED_SURFACE_HALF_XZ + ( 0.02 * S );
	const SLOPE_SURFACE_HALF_H = ELEVATED_SURFACE_HALF_H + ( 0.02 * S );
	const SLOPE_SURFACE_ANGLE_BIAS = THREE.MathUtils.degToRad( 0.9 );
