...
export function buildWallColliders( world, debugGroup, customCells, extras = null ) {
	...
	const ELEVATED_SEAM_CAP_PROFILE = [
		{ scale: 1.00, topRise: 0.120 * S, halfH: 0.030 * S },
		{ scale: 0.78, topRise: 0.165 * S, halfH: 0.028 * S },
		{ scale: 0.56, topRise: 0.205 * S, halfH: 0.026 * S },
		{ scale: 0.34, topRise: 0.240 * S, halfH: 0.024 * S },
	];
