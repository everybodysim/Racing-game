...
export function buildWallColliders( world, debugGroup, customCells, extras = null ) {
	...
	const ELEVATED_SURFACE_HALF_H = 0.13 * S;
	const ELEVATED_SURFACE_HALF_XZ = CELL_HALF * S * 1.12;
	const ELEVATED_SURFACE_DROP = 0.405;
	const SLOPE_SURFACE_HALF_XZ = ELEVATED_SURFACE_HALF_XZ + ( 0.01 * S );
	const SLOPE_SURFACE_HALF_H = ELEVATED_SURFACE_HALF_H + ( 0.01 * S );
