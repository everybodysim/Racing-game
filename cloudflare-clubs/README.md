...
[[kv_namespaces]]
binding = "CLUBS_KV"
id = "0e17b2a279354fbb8f35bfc9b4a1578c"
preview_id = "0e17b2a279354fbb8f35bfc9b4a1578c"
```
...
## 18) Preconfigured values used in this repo

- Worker URL: `https://racing-clubs-api.ga1010.workers.dev`
- KV binding: `CLUBS_KV`
- KV namespace id: `0e17b2a279354fbb8f35bfc9b4a1578c`

These are already wired into `clubs.html` and `worker/wrangler.toml`.
