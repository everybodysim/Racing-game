...
test( 'foam caps the tallest crests (surface texture)', /smoothstep\( 0\.13, 0\.2, vWaveH \)/.test( shader ) && /vWaveH = hC \* vWaveDistFade;/.test( track ) );
...
test( 'Track.js module cache param bumped (it changed)', main.includes( 'Track.js?v=1000214' ) );
